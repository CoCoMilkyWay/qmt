...
| filter | revenue_st   | 时序 | itf:forecast, itf:cn_stock_financial_changedate, rev_raw, meta:list_sector   | 状态机 (per A) ∧ `meta.list_sector == 1 ∧ rev_raw < (3e8 if end_date.Y ≥ 2024 else 1e8)`:                                                                                                                                                              | 同 profit_st 终止条件; 主板判定 inline `meta.list_sector[a] == 1` (int8 编码: 1=主板 / 2=创业板 / 3=科创板 / 4=北交所; asset 静态)                                                                                                                                                                          |
...
| filter | risk_warn    | 时序 | itf:cn_stock_status                                                          | `cn_stock_status.st_status` (int8 → float; 0=正常, 1=ST, 2=*ST)                                                                                                                                                                                        | 每日全量快照 (hybrid 伪装: 历史 day file 假装盘前 + last_d 由 `cn_stock_static_data` 真盘前 09:00 填充), 无需状态机/回放; 数据起点前一律 0; 下游 cs_tradable 走 `> 0.5` OR, 1.0 / 2.0 均触发排除 (filter 语义保留)                                                                                          |
...
| factor | pe_ttm12     | 截面 | pe_raw                                                                       | `pct_rank(z(winsor_mad(1 / pe_raw)))`                                                                                                                                                                                                                  | —                                                                                                                                                                                                                                                                                                           |
| factor | pb_ttm3      | 截面 | pb_raw                                                                       | `pct_rank(z(winsor_mad(1 / pb_raw)))`                                                                                                                                                                                                                  | —                                                                                                                                                                                                                                                                                                           |
| factor | ps_ttm12     | 截面 | ps_raw                                                                       | `pct_rank(z(winsor_mad(1 / ps_raw)))`                                                                                                                                                                                                                  | —                                                                                                                                                                                                                                                                                                           |
| factor | pcf_ttm12    | 截面 | pcf_raw                                                                      | `pct_rank(z(winsor_mad(1 / pcf_raw)))`                                                                                                                                                                                                                 | —                                                                                                                                                                                                                                                                                                           |
| factor | roe_ttm12    | 截面 | roe_raw                                                                      | `pct_rank(z(winsor_mad(roe_raw)))`                                                                                                                                                                                                                     | —                                                                                                                                                                                                                                                                                                           |
| factor | roa_ttm12    | 截面 | roa_raw                                                                      | `pct_rank(z(winsor_mad(roa_raw)))`                                                                                                                                                                                                                     | —                                                                                                                                                                                                                                                                                                           |
| factor | dy_ttm12     | 截面 | dy_raw                                                                       | `pct_rank(z(winsor_mad(dy_raw)))`                                                                                                                                                                                                                      | —                                                                                                                                                                                                                                                                                                           |
...
| inter  | pe_raw       | 时序 | mcap_raw, itf:cn_stock_financial_ttm_shift                                   | TBD                                                                                                                                                                                                                                                    | [ratio]; ttm12; 支持负 PE                                                                                                                                                                                                                                                                                   |
| inter  | pb_raw       | 时序 | mcap_raw, itf:cn_stock_financial_balance_general_pit                         | TBD                                                                                                                                                                                                                                                    | [ratio]; ttm3 (MRQ)                                                                                                                                                                                                                                                                                         |
| inter  | ps_raw       | 时序 | mcap_raw, itf:cn_stock_financial_ttm_shift                                   | TBD                                                                                                                                                                                                                                                    | [ratio]; ttm12                                                                                                                                                                                                                                                                                              |
| inter  | dy_raw       | 时序 | itf:cn_stock_dividend, share_raw, mcap_raw                                   | TBD                                                                                                                                                                                                                                                    | [ratio]; ttm12                                                                                                                                                                                                                                                                                              |
| inter  | pcf_raw      | 时序 | mcap_raw, itf:cn_stock_financial_ttm_shift                                   | TBD                                                                                                                                                                                                                                                    | [ratio]; ttm12                                                                                                                                                                                                                                                                                              |
| inter  | roe_raw      | 时序 | itf:cn_stock_financial_ttm_shift, itf:cn_stock_financial_balance_general_pit | TBD                                                                                                                                                                                                                                                    | [%]; ttm12                                                                                                                                                                                                                                                                                                  |
| inter  | roa_raw      | 时序 | itf:cn_stock_financial_ttm_shift, itf:cn_stock_financial_balance_general_pit | TBD                                                                                                                                                                                                                                                    | [%]; ttm12                                                                                                                                                                                                                                                                                                  |
| inter  | rev_raw      | 时序 | itf:cn_stock_financial_ttm_shift                                             | TBD                                                                                                                                                                                                                                                    | [元]; ttm12                                                                                                                                                                                                                                                                                                 |
...
- **agnostic 外层 + 单点真理**: `pit.cpp` (itf 维, 每 itf 一组 `{prealloc, parse, post_sort?, post_ffill?}` + `ITFS[]` 表挂载), `feature.cpp` (feature 维, 每 feature 一个 `ts_xxx` / `cs_xxx` + `FEATURES[]` 表挂载); 外层 flow (`load.cpp` / `ts.cpp` / `cs.cpp` / `build.cpp`) 仅通过函数指针表迭代调度, 不出现任何具体 itf 名 / feature 名.
...
Phase 2 时序  (per-A 并行; ts.cpp 通用 flow + feature.cpp 单点 feature 表)
  ...
  #     risk_warn   ← cn_stock_status.st_status[a, d]                        (int8 → float 三态: 0/1/2; 每日快照, 不需回放)
  ...
  #     revenue_st  ← profit_st 同区间, 区间内再叠 (meta.list_sector == 1 ∧ rev_raw < threshold(end_date.Y))
