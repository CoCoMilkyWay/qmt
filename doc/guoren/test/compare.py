...
_CPP_SPEC = {
    ...
    "pb_ttm1": (1.0, "rank", 0.0, 0.0),
    "pe_ttm12": (1.0, "rank", 0.0, 0.0),
    "pcf_ttm12": (1.0, "rank", 0.0, 0.0),
    "ps_ttm12": (1.0, "rank", 0.0, 0.0),
...
FACTORS = {
    ...
    "中性BP": (f_nbp, ("pb_ttm1", "中性BP")),
    "中性EP": (f_nep, ("pe_ttm12", "中性EP")),
    "中性CP": (f_ncp, ("pcf_ttm12", "中性CP")),
    "中性SP": (f_nsp, ("ps_ttm12", "中性SP")),
