...
查询方法详见get_fundamentals()接口说明，由于这个表是存量性质的， 查询年度数据是返回第四季度的数据。
...
other_comprehensive_income	其他综合收益(元)	(jqdatasdk1.9.5新增)

deferred_earning	非流动负债-递延收益(元)	(jqdatasdk1.9.5新增)

loan_and_advance_current_assets	流动资产-发放贷款及垫款(元)	(jqdatasdk1.9.5新增)

derivative_financial_asset	衍生金融资产(元)	(jqdatasdk1.9.5新增)

hold_sale_asset	划分为持有待售的资产(元)	(jqdatasdk1.9.5新增)

loan_and_advance_noncurrent_assets	非流动资产-发放贷款及垫款(元)	(jqdatasdk1.9.5新增)

derivative_financial_liability	衍生金融负债(元)	(jqdatasdk1.9.5新增)

hold_sale_liability	划分为持有待售的负债(元)	(jqdatasdk1.9.5新增)

estimate_liability_current	流动负债-预计负债(元)	(jqdatasdk1.9.5新增)

deferred_earning_current	流动负债-递延收益(元)	(jqdatasdk1.9.5新增)

preferred_shares_noncurrent	非流动负债-优先股(元)	(jqdatasdk1.9.5新增)

pepertual_liability_noncurrent	非流动负债-永续债(元)	(jqdatasdk1.9.5新增)

longterm_salaries_payable	长期应付职工薪酬(元)	(jqdatasdk1.9.5新增)

other_equity_tools	其他权益工具(元)	(jqdatasdk1.9.5新增)

preferred_shares_equity	其中：优先股-所有者权益	(jqdatasdk1.9.5新增)

pepertual_liability_equity	所有者权益-永续债(元)	(jqdatasdk1.9.5新增)

receivable_fin	应收款项融资(元)	(jqdatasdk1.9.5新增)

usufruct_assets	使用权资产(元)	(jqdatasdk1.9.5新增)

contract_assets	合同资产	(jqdatasdk1.9.5新增)

bond_invest	债权投资	(jqdatasdk1.9.5新增)

other_bond_invest	其他债权投资	(jqdatasdk1.9.5新增)

other_equity_tools_invest	其他权益工具投资	(jqdatasdk1.9.5新增)

other_non_current_financial_assets	其他非流动金融资产	(jqdatasdk1.9.5新增)

contract_liability	合同负债	(jqdatasdk1.9.5新增)

lease_liability	租赁负债	(jqdatasdk1.9.5新增)
