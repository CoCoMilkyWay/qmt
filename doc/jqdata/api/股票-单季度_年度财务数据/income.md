...
rd_expenses	研发费用	(jqdatasdk1.9.5新增)

asset_deal_income	资产处置收益	(jqdatasdk1.9.5新增)

sust_operate_net_profit	持续经营净利润	(jqdatasdk1.9.5新增)

discon_operate_net_profit	终止经营净利润	(jqdatasdk1.9.5新增)

credit_impairment_loss	信用减值损失	(jqdatasdk1.9.5新增)

net_open_hedge_income	净敞口套期收益	(jqdatasdk1.9.5新增)

interest_cost_fin	财务费用 - 利息费用	(jqdatasdk1.9.5新增)

interest_income_fin	财务费用 - 利息收入	(jqdatasdk1.9.5新增)

other_earnings	其他收益	(jqdatasdk1.9.5新增)

other_composite_income_mino_at	归属于少数股东的其他综合收益的	(jqdatasdk1.9.5新增)
