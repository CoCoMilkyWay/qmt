...
广期所	GFEX
Tick - Tick 行情
时间范围：最早支持2022.8.10，点击 (opens new window)了解更多体验版/专业版/券商版/机构版的Tick时间范围权限。
...
上期所、大商所、上海能源交易中心、广期所规则中，可交易真实合约代码为小写，如：SHFE.hc1710, DCE.i1805, INE.sc1809, GFEX.lc2405.
...
月份连续由真实合约拼接而成，symbol 标识为交易所.大写品种代码 到期日排序，如SHFE.RB00，SHFE.RB01，...，SHFE.RB04（同一品种最多有最近 5 个月的月份连续合约）。
...
Python 数据接口
fut_get_continuous_contracts - 查询连续合约对应的真实合约，可查询 期货主力连续、次主力连续、月份连续合约。
示例：
