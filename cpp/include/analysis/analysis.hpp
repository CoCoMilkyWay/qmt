...
//   - factor_turnover.npy    [n_factor, n_d_bt] f4 (top-K Jaccard turnover, K=BT_HOLD_N)
...
//   - quantile_ret.npy       [N_QUANTILES, n_d_bt] f4 (Q 分桶 当日 daily_return 等权均值)
