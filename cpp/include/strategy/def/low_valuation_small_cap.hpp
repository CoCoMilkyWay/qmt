...
inline constexpr std::array<std::string_view, 2> low_valuation_small_cap_exchange_wl = {{
    "上海证券交易所",
    "深圳证券交易所",
    //"北京证券交易所",
}};
...
// 申万 SW2021
inline constexpr std::array<std::string_view, 26> low_valuation_small_cap_industry_l1_wl = {{
    "交通运输",
    "传媒",
    "公用事业",
    //"农林牧渔",
...
inline constexpr const feature::FeatureSpec *low_valuation_small_cap_filters[] = {
...
inline constexpr StrategySpec low_valuation_small_cap{
    ...
    .pool =
        {
            ...
            .list_sector_wl = low_valuation_small_cap_list_sector_wl,
            .industry_l1_wl = low_valuation_small_cap_industry_l1_wl,
    ...
    .filters = low_valuation_small_cap_filters,
    .weights = low_valuation_small_cap_weights,
