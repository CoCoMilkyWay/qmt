...
inline constexpr std::array<std::string_view, 2> margin_small_cap_exchange_wl = {{
    "上海证券交易所",
    "深圳证券交易所",
    //"北京证券交易所",
}};

inline constexpr std::array<std::int8_t, 1> margin_small_cap_list_sector_wl = {{
    1, // 主板
       // 2, // 创业板
       // 3, // 科创板
       // 4, // 北交所
...
// 申万 SW2021
inline constexpr std::array<std::string_view, 26> margin_small_cap_industry_l1_wl = {{
    "交通运输",
    "传媒",
    "公用事业",
    //"农林牧渔",
...
inline constexpr const feature::FeatureSpec *margin_small_cap_filters[] = {
...
inline constexpr StrategySpec margin_small_cap{
    ...
    .pool =
        {
            .exchange_wl = margin_small_cap_exchange_wl,
            .list_sector_wl = margin_small_cap_list_sector_wl,
            .industry_l1_wl = margin_small_cap_industry_l1_wl,
